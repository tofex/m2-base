...
namespace Tofex\Base\Model;

use Exception;
use Magento\AdminNotification\Model\InboxFactory;
use Pest;
use Psr\Log\LoggerInterface;
use Tofex\Base\Helper\Data;
...
class Cron
{
    ...
    public function checkSolutions()
    {
        ...
        $dateQuery->where('path = ?', 'tofex_base/solution/date');
    ...
    public function checkPackages()
    {
        ...
        $versionQuery->where('path = ?', 'tofex_base/package/versions');
        ...
        $this->databaseHelper->createTableData($this->databaseHelper->getDefaultConnection(),
            $this->databaseHelper->getTableName('core_config_data'), [
                'scope'    => 'default',
                'scope_id' => 0,
                'path'     => 'tofex_base/package/versions',
